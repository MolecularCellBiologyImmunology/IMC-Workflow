...
path = f"{current_directory}/Results/Spatial_output/20250806_allROIs_25px_HNSCC_neighbours_distanceCalculation_allCells_nb1_community4.csv"
...
# Save file
output_path = f"{current_directory}/Results/Spatial_output/"

# totalscid.to_csv(f"{output_path}frequencies_cells_{cutoff}px_{date}.csv", index = False)
freq.to_csv(f"{output_path}frequencies_{cutoff}px_nb1_community4_{date}.csv", index = False)
